      ...
      <div className="nf-page">
        ...
        <div className={`nf-main ${mounted ? 'show' : ''}`}>
          ...
          <div className="nf-illustration">
            <svg className="nf-dog" viewBox="0 0 200 180" fill="none">
              ...
              <g className="nf-dog-ear">
                <ellipse cx="130" cy="68" rx="14" ry="20" fill="#D4871A" transform="rotate(-20 130 68)" />
              </g>
              {/* Tail */}
              ...
              {/* Mouth */}
              <path d="M168 102 Q172 106 176 102" stroke="#2C1810" strokeWidth="1.5" strokeLinecap="round" fill="none" />
              {/* Tongue */}
              <ellipse cx="174" cy="106" rx="4" ry="5" fill="#E05C5C" />
              {/* 404 on dog sign */}
              <rect x="62" y="88" width="52" height="28" rx="4" fill="#fff" stroke="#ddd" />
              <text x="88" y="107" textAnchor="middle" fontSize="13" fontWeight="800" fill="#C45500" fontFamily="Arial">404</text>
            </svg>
          </div>
          ...
          <p className="nf-desc">
            ...
            Try searching below or <a onClick={() => navigate('/')}>go back to the homepage</a>.
          </p>
