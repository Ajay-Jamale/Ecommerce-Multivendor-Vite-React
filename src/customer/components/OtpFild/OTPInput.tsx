...
const OTPInput: React.FC<OTPInputProps> = ({ length, onChange, error = false }) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      {/* Progress track */}
      <div style={{
        height: 2, background: '#e5e7eb', borderRadius: 2, overflow: 'hidden', marginBottom: 4,
      }}>
        <div style={{
          height: '100%',
...
export const OTPField: React.FC<OTPFieldProps> = ({ label, error, helperText }) => {
            ...
            <div key={index} style={{ position: 'relative', flex: 1 }}>
              ...
              {isFilled && !isFocused && (
                <div style={{
                  ...
                  borderRadius: '50%', background: error ? '#ef4444' : '#0d9488', opacity: 0.5,
                }} />
              )}
            </div>
          );
